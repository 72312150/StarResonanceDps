...
namespace StarResonanceDpsAnalysis.WinForm.Forms
{
    public partial class SettingsForm : BorderlessForm
    {
        ...
        /// <summary>
        /// Detect theme (foreground color) changes for the window
        /// </summary>
        ...
        /// <summary>
        /// Handle mouse press on the title label
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        /// <remarks>
        ...
        /// <summary>
        /// Mouse-through hotkey verification
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        ...
        /// <summary>
        /// Clear-data hotkey verification
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
