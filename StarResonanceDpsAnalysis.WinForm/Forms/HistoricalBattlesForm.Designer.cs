namespace StarResonanceDpsAnalysis.WinForm.Forms
{
    partial class HistoricalBattlesForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            select2.Items.AddRange(new object[] { "Sort by Damage", "Sort by Healing", "Sort by Damage Taken" });
            select2.List = true;
            ...
            segmentedItem1.Text = "Single Fight Damage Records";
            segmentedItem2.Text = "Full Run Damage Records";
